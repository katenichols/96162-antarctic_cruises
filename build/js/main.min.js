...
document.addEventListener('keydown', function (evt) {
  if (_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeaderWrapper"].classList.contains('page-header__wrapper--modal')) {
    if (evt.key === 'Tab') {
      if (evt.shiftKey) {
...
var classListsToggle = function classListsToggle() {
  if (!pageHeader.classList.contains('page-header--modal')) {
    ...
    body.style.top = '0'; // body.style.transform = 'translate3d(0, 0, 0)';
  } else {
    body.style.position = 'relative';
    body.style.top = 'auto'; // body.style.transform = 'translate3d(0, 0, 0)';
  }
