...
var pageHeader = document.querySelector('[data-header-mobile]');
...
var navNoJs = document.querySelector('[data-nav-nojs]');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  navList.classList.remove('nav__list--no-js'); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
