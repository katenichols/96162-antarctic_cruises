...
/* harmony import */ var _modules_anchors__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_anchors__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_nav_link_click__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/nav-link-click */ "./js/modules/nav-link-click.js");
...
/* harmony import */ var _modules_nav_btn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/nav-btn */ "./js/modules/nav-btn.js");



var closeModal = function closeModal() {
  Object(_modules_nav_btn__WEBPACK_IMPORTED_MODULE_1__["classListsToggle"])();
  document.removeEventListener('keydown', _utils_esc_key__WEBPACK_IMPORTED_MODULE_0__["onEscKeydown"]);
};
...
/*!*******************************!*\
  !*** ./js/modules/nav-btn.js ***!
  \*******************************/
/*! exports provided: navBtn, pageHeader, pageHeaderWrapper, pageHeaderPicture, pageHeaderPictureModal, nav, navList, classListsToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var pageHeaderWrapper = document.querySelector('[data-header-wrapper]');
var pageHeaderPicture = document.querySelector('[data-header-picture]');
var pageHeaderPictureModal = document.querySelector('[data-header-picture-modal');
var nav = document.querySelector('[data-nav]');
var navList = document.querySelector('[data-nav-list-nojs]');
...
var navLinks = _modules_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeader"].querySelectorAll('.nav__link');

var onNavLinkClick = function onNavLinkClick() {
  if (_modules_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeader"].classList.contains('page-header--modal')) {
...
var escKey = function escKey(evt) {
  if ((evt.key === 'Escape' || evt.key === 'Esc') && !evt.target.classList.contains('text__hashtags') && !evt.target.classList.contains('text__description')) {
    return true;
  }
};
